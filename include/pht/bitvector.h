//
// Created by Christopher Pack on 19.08.2021.
//
//Implementation of a space efficient bitvector supporting rank and select in O(1)
//using preset: https://github.com/Kurorororo/succinct-bit-vector
...
namespace pht {
    class __declspec(dllexport) BitVector {
    public:
    ...
    private:
        ...
        template<class T> void __declspec(dllexport) Init(const T &v) {
            if (v.empty()) {
        ...
        template<class T> void __declspec(dllexport) InitVector(const T &v);
        ...
        class __declspec(dllexport) SelectIndex {
        public:
        ...
        class __declspec(dllexport) SelectIndexArray : public SelectIndex {
        public:
        ...
        class __declspec(dllexport) SelectIndexTree : public SelectIndex {
        public:
